...
use App\Events\DonationOfferAccepted;
use App\Models\SystemLog;

class LogDonationOfferAccepted
{
    /**
     * Handle the event.
     */
    public function handle(DonationOfferAccepted $event): void
    {
        ...
        SystemLog::log(
            ...
            sprintf(
                'Donation offer #%s for %s (%d %s) accepted by %s',
