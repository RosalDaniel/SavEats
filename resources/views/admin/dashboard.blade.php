        ...
        <div class="activity-list">
            @if(isset($recentActivities) && $recentActivities->count() > 0)
                @foreach($recentActivities as $activity)
                    @if($activity['type'] === 'establishment')
                        @php $establishment = $activity['data']; @endphp
                    ...
                    @elseif($activity['type'] === 'consumer')
                        @php $consumer = $activity['data']; @endphp
                        <div class="activity-item">
                    ...
                    @elseif($activity['type'] === 'donation')
                        @php $donation = $activity['data']; @endphp
                        <div class="activity-item">
