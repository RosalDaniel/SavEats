            ...
            <div class="section-content">
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        ...
                        <p class="announcement-text">We're rolling out a new feature to make donation requests even smoother. Stay tuned for updates!</p>
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        ...
                        <p class="announcement-text">Limited-time offer! New partnerships available. Connect with more establishments and expand your network!</p>
                        <div class="announcement-meta">
                            <span class="announcement-time">23 mins.</span>
                        </div>
                        <div class="announcement-action">
                            <button class="action-button">
                                <span>Go to Partner Network</span>
...
<script>
    // Update action button to redirect to foodbank partner network
    document.addEventListener('DOMContentLoaded', function() {
        const actionButtons = document.querySelectorAll('.action-button');
        actionButtons.forEach(button => {
            const span = button.querySelector('span');
            if (span && span.textContent.includes('Go to Partner Network')) {
                button.addEventListener('click', function() {
                    window.location.href = '{{ route("foodbank.partner-network") }}';
                });
            }
        });
    });
