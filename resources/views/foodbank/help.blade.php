...
<div class="help-center-container">
    ...
    <div class="quick-help-section">
        ...
        <div class="help-categories">
            ...
            <div class="help-category" onclick="showCategory('donations')">
                <div class="category-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="help-category" onclick="showCategory('distribution')">
                <div class="category-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="help-category" onclick="showCategory('partnerships')">
                <div class="category-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="help-category" onclick="showCategory('reports')">
                <div class="category-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
