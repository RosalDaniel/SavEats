...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
        ...
        <li class="nav-item">
            <a href="{{ route('consumer.announcements') }}" class="nav-link {{ request()->routeIs('consumer.announcements') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" viewBox="0 0 640 640">
        ...
        <li class="nav-item">
            <a href="{{ route('consumer.my-impact') }}" class="nav-link {{ request()->routeIs('consumer.my-impact') ? 'active' : '' }}">
                <svg class="nav-icon" viewBox="0 0 24 24">
