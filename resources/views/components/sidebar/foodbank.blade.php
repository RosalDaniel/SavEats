...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.donation-request') }}" class="nav-link {{ request()->routeIs('foodbank.donation-request') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.announcements') }}" class="nav-link {{ request()->routeIs('foodbank.announcements') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" viewBox="0 0 640 640">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.impact-reports') }}" class="nav-link {{ request()->routeIs('foodbank.impact-reports') ? 'active' : '' }}">
                <svg class="nav-icon" viewBox="0 0 24 24">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.partner-network') }}" class="nav-link {{ request()->routeIs('foodbank.partner-network') ? 'active' : '' }}">
                <svg class="nav-icon" viewBox="0 0 24 24">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.settings') }}" class="nav-link {{ request()->routeIs('foodbank.settings') ? 'active' : '' }}">
                <svg class="nav-icon" viewBox="0 0 24 24">
        ...
        <li class="nav-item">
            <a href="{{ route('foodbank.help') }}" class="nav-link {{ request()->routeIs('foodbank.help') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" viewBox="0 0 640 640">
